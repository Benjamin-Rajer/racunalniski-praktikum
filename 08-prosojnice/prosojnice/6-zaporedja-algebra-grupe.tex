\begin{frame}{Zaporedja, vrste in limite}
	\begin{enumerate}
		...
		\item
		Izračunaj limito
		$$\lim_{n\rightarrow\infty}(sin\sqrt{x + 1} - sin\sqrt{x}).$$
		...
		$$a_n = \underbrace{\sqrt{2+\sqrt{2+\dots+\sqrt{2}}}}_{\text{\textit{n} korenov}} \qquad b_n = \underbrace{\sin(\sin(\dots(\sin 1)\dots))}_{\text{\textit{n} sinusov}}$$
	\end{enumerate}
\end{frame}
